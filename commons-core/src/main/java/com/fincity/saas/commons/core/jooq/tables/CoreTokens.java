...
public class CoreTokens extends TableImpl<CoreTokensRecord> {
     ...
     * token
     */
    public final TableField<CoreTokensRecord, Map> TOKEN_METADATA = createField(DSL.name("TOKEN_METADATA"), SQLDataType.JSON, this, "Metadata of the token", new JSONMysqlMapConvertor());
