...
public class CoreTokensRecord extends UpdatableRecordImpl<CoreTokensRecord> {
     ...
     * token
     */
    public CoreTokensRecord setTokenMetadata(Map value) {
        set(8, value);
        return this;
    }
     ...
     */
    public CoreTokensRecord(ULong id, ULong userId, String clientCode, String appCode, String state, String connectionName, CoreTokensTokenType tokenType, String token, Map tokenMetadata, Byte isRevoked, LocalDateTime expiresAt, Byte isLifetimeToken, ULong createdBy, ULong updatedBy, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(CoreTokens.CORE_TOKENS);
