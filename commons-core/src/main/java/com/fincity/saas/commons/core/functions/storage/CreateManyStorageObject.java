    ...
    public FunctionSignature getSignature() {
        ...
        return new FunctionSignature()
                ...
                .setParameters(Map.of(
                        ...
                        DATA_ARRAY,
                        new Parameter()
                                .setParameterName(DATA_ARRAY)
                                .setSchema(Schema.ofArray(DATA_ARRAY)
                                        .setItems(ArraySchemaType.of(Schema.ofAny(DATA_ARRAY)))),
                        APP_CODE,
    ...
    protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
        ...
        return appDataService
                .createMany(
                        ...
                        eagerFields)
                .map(arr ->
                        new FunctionOutput(List.of(EventResult.outputOf(Map.of(EVENT_RESULT, gson.toJsonTree(arr))))));
    }
}
