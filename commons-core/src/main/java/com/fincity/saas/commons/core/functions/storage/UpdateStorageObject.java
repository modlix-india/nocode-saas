...
public class UpdateStorageObject extends AbstractReactiveFunction {
    ...
    public FunctionSignature getSignature() {
        ...
        return new FunctionSignature()
                ...
                .setParameters(Map.of(
                        ...
                        ISPARTIAL,
                        Parameter.of(ISPARTIAL, Schema.ofBoolean(ISPARTIAL).setDefaultValue(new JsonPrimitive(false))),
                        DATA_OBJECT_ID,
                        Parameter.of(DATA_OBJECT_ID, Schema.ofString(DATA_OBJECT_ID)),
                        DATA_OBJECT,
    ...
    protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
        ...
        JsonObject updatableObject = context.getArguments().get(DATA_OBJECT).getAsJsonObject();
        ...
        if (storageName == null)
            return Mono.just(new FunctionOutput(List.of(EventResult.of(
                    Event.ERROR, Map.of(Event.ERROR, new JsonPrimitive("Please provide the storage" + " name."))))));
