...
public class NotificationTemplate extends TableImpl<NotificationTemplateRecord> {
     ...
     */
    public final TableField<NotificationTemplateRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.CHAR(36).nullable(false), this, "Code");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.NOTIFICATION_TEMPLATE_IDX1_NOTIFICATION_TYPE_CLIENT_ID_APP_ID, Indexes.NOTIFICATION_TEMPLATE_IDX2_NOTIFICATION_TYPE_APP_ID);
    }
    ...
    public List<UniqueKey<NotificationTemplateRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_NOTIFICATION_TEMPLATE_UK1_NOTIFICATION_TYPE_CODE_CLIENT_ID_APP_ID);
    }
