...
public class NotificationUserPreferences extends TableImpl<NotificationUserPreferencesRecord> {
     ...
     * Primary key
     */
    public final TableField<NotificationUserPreferencesRecord, ULong> ID = createField(
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, String> CODE = createField(
     ...
     * security_app table
     */
    public final TableField<NotificationUserPreferencesRecord, ULong> APP_ID = createField(
            DSL.name("APP_ID"),
            SQLDataType.BIGINTUNSIGNED.nullable(false),
            this,
            "App Id for which this user preference is getting created. References security_app table");
     ...
     * security_user table
     */
    public final TableField<NotificationUserPreferencesRecord, ULong> USER_ID = createField(
            DSL.name("USER_ID"),
            SQLDataType.BIGINTUNSIGNED.nullable(false),
            this,
            "App User Id under which this user preference is getting created. References security_user table");
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, Map> PREFERENCES = createField(
            DSL.name("PREFERENCES"),
            SQLDataType.JSON,
            this,
            "Notification preference",
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, Byte> ENABLED = createField(
            DSL.name("ENABLED"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("1", SQLDataType.TINYINT)),
            this,
            "Notification enabled or not");
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, ULong> CREATED_BY = createField(
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, LocalDateTime> CREATED_AT = createField(
            DSL.name("CREATED_AT"),
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, ULong> UPDATED_BY = createField(
     ...
     */
    public final TableField<NotificationUserPreferencesRecord, LocalDateTime> UPDATED_AT = createField(
            DSL.name("UPDATED_AT"),
            SQLDataType.LOCALDATETIME(0)
                    .nullable(false)
                    .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)),
    ...
    private NotificationUserPreferences(
            Name alias, Table<NotificationUserPreferencesRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public List<UniqueKey<NotificationUserPreferencesRecord>> getUniqueKeys() {
        return Arrays.asList(
                Keys.KEY_NOTIFICATION_USER_PREFERENCES_UK1_USER_PREF_CODE,
                Keys.KEY_NOTIFICATION_USER_PREFERENCES_UK2_USER_NOTI_PREF_APP_ID_USER_ID_NAME);
    }
