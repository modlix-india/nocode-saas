...
public class Keys {
    ...
    public static final UniqueKey<NotificationConnectionRecord> KEY_NOTIFICATION_CONNECTION_UK1_NOTIFICATION_TYPE_CODE = Internal.createUniqueKey(NotificationConnection.NOTIFICATION_CONNECTION, DSL.name("KEY_notification_connection_UK1_NOTIFICATION_TYPE_CODE"), new TableField[] { NotificationConnection.NOTIFICATION_CONNECTION.CODE }, true);
    ...
    public static final UniqueKey<NotificationNotificationRecord> KEY_NOTIFICATION_NOTIFICATION_UK1_NOTIFICATION_TYPE_CODE = Internal.createUniqueKey(NotificationNotification.NOTIFICATION_NOTIFICATION, DSL.name("KEY_notification_notification_UK1_NOTIFICATION_TYPE_CODE"), new TableField[] { NotificationNotification.NOTIFICATION_NOTIFICATION.CODE }, true);
    ...
    public static final UniqueKey<NotificationTemplateRecord> KEY_NOTIFICATION_TEMPLATE_UK1_NOTIFICATION_TYPE_CODE = Internal.createUniqueKey(NotificationTemplate.NOTIFICATION_TEMPLATE, DSL.name("KEY_notification_template_UK1_NOTIFICATION_TYPE_CODE"), new TableField[] { NotificationTemplate.NOTIFICATION_TEMPLATE.CODE }, true);
    ...
    public static final UniqueKey<NotificationTypeRecord> KEY_NOTIFICATION_TYPE_UK1_NOTIFICATION_TYPE_CODE = Internal.createUniqueKey(NotificationType.NOTIFICATION_TYPE, DSL.name("KEY_notification_type_UK1_NOTIFICATION_TYPE_CODE"), new TableField[] { NotificationType.NOTIFICATION_TYPE.CODE }, true);
    ...
    public static final ForeignKey<NotificationNotificationRecord, NotificationTemplateRecord> FK5_NOTIFICATION_PUSH_TEMPLATE = Internal.createForeignKey(NotificationNotification.NOTIFICATION_NOTIFICATION, DSL.name("FK5_NOTIFICATION_PUSH_TEMPLATE"), new TableField[] { NotificationNotification.NOTIFICATION_NOTIFICATION.PUSH_TEMPLATE_ID }, Keys.KEY_NOTIFICATION_TEMPLATE_PRIMARY, new TableField[] { NotificationTemplate.NOTIFICATION_TEMPLATE.ID }, true);
