...
public class NotificationSentNotifications extends TableImpl<NotificationSentNotificationsRecord> {
    ...
    public static final NotificationSentNotifications NOTIFICATION_SENT_NOTIFICATIONS =
            new NotificationSentNotifications();
     ...
     * Primary key
     */
    public final TableField<NotificationSentNotificationsRecord, ULong> ID = createField(
            DSL.name("ID"), SQLDataType.BIGINTUNSIGNED.nullable(false).identity(true), this, "Primary key");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, String> CODE = createField(
            DSL.name("CODE"), SQLDataType.CHAR(22).nullable(false), this, "Unique Code to identify this row");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, String> APP_CODE = createField(
            DSL.name("APP_CODE"),
            SQLDataType.CHAR(64).nullable(false),
            this,
            "App Code on which this notification was sent. References security_app table");
     ...
     * table
     */
    public final TableField<NotificationSentNotificationsRecord, String> CLIENT_CODE = createField(
            DSL.name("CLIENT_CODE"),
            SQLDataType.CHAR(8).nullable(false),
            this,
            "Client Code to whom this notification we sent. References security_user table");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, ULong> USER_ID = createField(
            DSL.name("USER_ID"),
            SQLDataType.BIGINTUNSIGNED.nullable(false),
            this,
            "Identifier for the user. References security_user table");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, String> NOTIFICATION_TYPE = createField(
            DSL.name("NOTIFICATION_TYPE"),
            SQLDataType.VARCHAR(11).nullable(false).defaultValue(DSL.inline("INFO", SQLDataType.VARCHAR)),
            this,
            "Type of notification that is sent");
    ...
    public final TableField<NotificationSentNotificationsRecord, NotificationChannel> NOTIFICATION_CHANNEL =
            createField(
                    DSL.name("NOTIFICATION_CHANNEL"),
                    SQLDataType.JSON.nullable(false),
                    this,
                    "Notification message that is sent in different channels",
                    new JSONtoClassConverter<JSON, NotificationChannel>(JSON.class, NotificationChannel.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, String> NOTIFICATION_STAGE = createField(
            DSL.name("NOTIFICATION_STAGE"),
            SQLDataType.VARCHAR(8).nullable(false).defaultValue(DSL.inline("PLATFORM", SQLDataType.VARCHAR)),
            this,
            "Stage of the notification that is sent");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, LocalDateTime> TRIGGER_TIME = createField(
            DSL.name("TRIGGER_TIME"),
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Byte> IS_EMAIL = createField(
            DSL.name("IS_EMAIL"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Email notification enabled or not");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Map> EMAIL_DELIVERY_STATUS = createField(
            DSL.name("EMAIL_DELIVERY_STATUS"),
            SQLDataType.JSON,
            this,
            "Email delivery status",
            new JSONtoClassConverter<JSON, Map>(JSON.class, Map.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Byte> IS_IN_APP = createField(
            DSL.name("IS_IN_APP"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "In-app notification enabled or not");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Map> IN_APP_DELIVERY_STATUS = createField(
            DSL.name("IN_APP_DELIVERY_STATUS"),
            SQLDataType.JSON,
            this,
            "In-app delivery status",
            new JSONtoClassConverter<JSON, Map>(JSON.class, Map.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Byte> IS_MOBILE_PUSH = createField(
            DSL.name("IS_MOBILE_PUSH"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Mobile push notification enabled or not");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Map> MOBILE_PUSH_DELIVERY_STATUS = createField(
            DSL.name("MOBILE_PUSH_DELIVERY_STATUS"),
            SQLDataType.JSON,
            this,
            "Mobile push delivery status",
            new JSONtoClassConverter<JSON, Map>(JSON.class, Map.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Byte> IS_WEB_PUSH = createField(
            DSL.name("IS_WEB_PUSH"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Web push notification enabled or not");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Map> WEB_PUSH_DELIVERY_STATUS = createField(
            DSL.name("WEB_PUSH_DELIVERY_STATUS"),
            SQLDataType.JSON,
            this,
            "Web push delivery status",
            new JSONtoClassConverter<JSON, Map>(JSON.class, Map.class));
     ...
     * notification enabled or not
     */
    public final TableField<NotificationSentNotificationsRecord, Byte> IS_SMS = createField(
            DSL.name("IS_SMS"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "SMS notification enabled or not");
     ...
     * SMS delivery status
     */
    public final TableField<NotificationSentNotificationsRecord, Map> SMS_DELIVERY_STATUS = createField(
            DSL.name("SMS_DELIVERY_STATUS"),
            SQLDataType.JSON,
            this,
            "SMS delivery status",
            new JSONtoClassConverter<JSON, Map>(JSON.class, Map.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Byte> IS_ERROR = createField(
            DSL.name("IS_ERROR"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "If we are getting error in notification or not");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, NotificationErrorInfo> ERROR_INFO = createField(
            DSL.name("ERROR_INFO"),
            SQLDataType.JSON,
            this,
            "Error info if error occurs during this notification",
            new JSONtoClassConverter<JSON, NotificationErrorInfo>(JSON.class, NotificationErrorInfo.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, Map> CHANNEL_ERRORS = createField(
            DSL.name("CHANNEL_ERRORS"),
            SQLDataType.JSON,
            this,
            "Channel Errors if error occurs during channel listeners processing",
            new JSONtoClassConverter<JSON, Map>(JSON.class, Map.class));
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, ULong> CREATED_BY = createField(
            DSL.name("CREATED_BY"), SQLDataType.BIGINTUNSIGNED, this, "ID of the user who created this row");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, LocalDateTime> CREATED_AT = createField(
            DSL.name("CREATED_AT"),
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, ULong> UPDATED_BY = createField(
            DSL.name("UPDATED_BY"), SQLDataType.BIGINTUNSIGNED, this, "ID of the user who updated this row");
     ...
     */
    public final TableField<NotificationSentNotificationsRecord, LocalDateTime> UPDATED_AT = createField(
            DSL.name("UPDATED_AT"),
            SQLDataType.LOCALDATETIME(0)
                    .nullable(false)
                    .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)),
    ...
    private NotificationSentNotifications(
            Name alias, Table<NotificationSentNotificationsRecord> aliased, Field<?>[] parameters, Condition where) {
