...
public class NotificationAppPreference extends TableImpl<NotificationAppPreferenceRecord> {
    ...
    /**
     * The column <code>notification.notification_app_preference.CODE</code>.
     * Unique Code to identify this row
     */
    public final TableField<NotificationAppPreferenceRecord, String> CODE = createField(DSL.name("CODE"), SQLDataType.CHAR(22).nullable(false), this, "Unique Code to identify this row");
     ...
     */
    public final TableField<NotificationAppPreferenceRecord, JSON> PREFERENCES = createField(DSL.name("PREFERENCES"), SQLDataType.JSON, this, "Notification app preferences");
    ...
    public List<UniqueKey<NotificationAppPreferenceRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_NOTIFICATION_APP_PREFERENCE_UK1_APP_PREF_CLIENT_ID_APP_ID, Keys.KEY_NOTIFICATION_APP_PREFERENCE_UK1_APP_PREF_CODE);
    }
