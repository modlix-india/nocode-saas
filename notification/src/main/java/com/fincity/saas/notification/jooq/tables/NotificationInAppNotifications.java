...
public class NotificationInAppNotifications extends TableImpl<NotificationInAppNotificationsRecord> {
    ...
    public static final NotificationInAppNotifications NOTIFICATION_IN_APP_NOTIFICATIONS =
            new NotificationInAppNotifications();
     ...
     * key
     */
    public final TableField<NotificationInAppNotificationsRecord, ULong> ID = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, String> CODE = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, String> APP_CODE = createField(
            DSL.name("APP_CODE"),
     ...
     * table
     */
    public final TableField<NotificationInAppNotificationsRecord, String> CLIENT_CODE = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, ULong> USER_ID = createField(
            DSL.name("USER_ID"),
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, String> NOTIFICATION_TYPE = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, InAppMessage> IN_APP_MESSAGE = createField(
            DSL.name("IN_APP_MESSAGE"),
            SQLDataType.JSON.nullable(false),
            this,
            "In-App Notification message that is sent",
            new JSONtoClassConverter<JSON, InAppMessage>(JSON.class, InAppMessage.class));
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, String> NOTIFICATION_STAGE = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, String> NOTIFICATION_DELIVERY_STATUS = createField(
            DSL.name("NOTIFICATION_DELIVERY_STATUS"),
            SQLDataType.VARCHAR(9).nullable(false).defaultValue(DSL.inline("NO_INFO", SQLDataType.VARCHAR)),
            this,
            "Current Delivery status of this notification message");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, Map> ACTIONS = createField(
            DSL.name("ACTIONS"),
            SQLDataType.JSON,
            this,
            "Actions to be performed on this notification",
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> TRIGGER_TIME = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, Byte> SENT = createField(
            DSL.name("SENT"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Is this notification is sent or not");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> SENT_TIME = createField(
            DSL.name("SENT_TIME"), SQLDataType.LOCALDATETIME(0), this, "Time when this notification was sent");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, Byte> DELIVERED = createField(
            DSL.name("DELIVERED"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Is this notification is delivered or not");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> DELIVERED_TIME = createField(
            DSL.name("DELIVERED_TIME"),
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, Byte> READ = createField(
            DSL.name("READ"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Is this notification is read or not");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> READ_TIME = createField(
            DSL.name("READ_TIME"), SQLDataType.LOCALDATETIME(0), this, "Time when this notification was read by user");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, Byte> FAILED = createField(
            DSL.name("FAILED"),
            SQLDataType.TINYINT.nullable(false).defaultValue(DSL.inline("0", SQLDataType.TINYINT)),
            this,
            "Is this notification is failed or not");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> FAILED_TIME = createField(
            DSL.name("FAILED_TIME"), SQLDataType.LOCALDATETIME(0), this, "Time when this notification was failed");
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, ULong> CREATED_BY = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> CREATED_AT = createField(
            DSL.name("CREATED_AT"),
            SQLDataType.LOCALDATETIME(0)
                    .nullable(false)
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, ULong> UPDATED_BY = createField(
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, LocalDateTime> UPDATED_AT = createField(
            DSL.name("UPDATED_AT"),
            SQLDataType.LOCALDATETIME(0)
                    .nullable(false)
                    .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)),
    ...
    private NotificationInAppNotifications(
            Name alias, Table<NotificationInAppNotificationsRecord> aliased, Field<?>[] parameters, Condition where) {
