...
public class NotificationInAppNotifications extends TableImpl<NotificationInAppNotificationsRecord> {
     ...
     */
    public final TableField<NotificationInAppNotificationsRecord, String> NOTIFICATION_TYPE = createField(DSL.name("NOTIFICATION_TYPE"), SQLDataType.VARCHAR(11).nullable(false).defaultValue(DSL.inline("INFO", SQLDataType.VARCHAR)), this, "Type of notification that is sent");
