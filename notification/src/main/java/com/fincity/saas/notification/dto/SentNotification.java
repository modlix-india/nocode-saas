...
public class SentNotification extends AbstractUpdatableDTO<ULong, ULong> {
    ...
    public void updateChannelInfo(
            ...
            Boolean isEnabled,
            Map<String, LocalDateTime> deliveryStatus,
            boolean override) {
        ...
        switch (channelType) {
            ...
            case IN_APP ->
                this.updateChannelInfo(
                        ...
                        deliveryStatus,
                        this::setInApp,
                        this::getInAppDeliveryStatus,
                        this::setInAppDeliveryStatus,
                        override);
            case MOBILE_PUSH ->
                this.updateChannelInfo(
                        isEnabled,
                        deliveryStatus,
                        this::setMobilePush,
                        this::getMobilePushDeliveryStatus,
                        this::setMobilePushDeliveryStatus,
                        override);
            case WEB_PUSH ->
                this.updateChannelInfo(
                        isEnabled,
                        deliveryStatus,
                        this::setWebPush,
                        this::getWebPushDeliveryStatus,
                        this::setWebPushDeliveryStatus,
                        override);
            case SMS ->
                this.updateChannelInfo(
                        isEnabled,
    ...
    private void updateChannelInfo(
            ...
            Supplier<Map<String, LocalDateTime>> getStatus,
            Consumer<Map<String, LocalDateTime>> setStatus,
            boolean override) {
        ...
        Map<String, LocalDateTime> currentStatus =
                override ? getStatus.get() : HashMap.newHashMap(DELIVERY_STATUS_SIZE);
    ...
    public SentNotification setErrorInfo(NotificationErrorInfo notificationErrorInfo) {
        ...
        if (notificationErrorInfo == null) return this;
    ...
    public SentNotification setChannelErrorInfo(Map<String, NotificationErrorInfo> channelErrors) {
        ...
        if (channelErrors == null || channelErrors.isEmpty()) return this;

        if (this.channelErrors == null) this.channelErrors = HashMap.newHashMap(CHANNEL_SIZE);
