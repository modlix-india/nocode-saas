...
public class NotificationEventController {
    ...
    @GetMapping(path = "/subscribe/{appCode}/{clientCode}/{userId}", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<ServerSentEvent<SendResponse<InAppMessage>>> subscribeToEvent(
            @PathVariable String appCode, @PathVariable String clientCode, @PathVariable BigInteger userId) {
