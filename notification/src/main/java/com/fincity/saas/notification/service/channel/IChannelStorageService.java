...
public interface IChannelStorageService<
                I extends Serializable, D extends AbstractUpdatableDTO<I, I>, T extends IChannelStorageService<I, D, T>>
        extends ChannelType {

    Mono<D> saveChannelNotification(
            SendRequest request,
            LocalDateTime triggerTime,
            NotificationStage notificationStage,
            NotificationDeliveryStatus deliveryStatus);

    Mono<D> updateChannelNotification(
            SendRequest request,
