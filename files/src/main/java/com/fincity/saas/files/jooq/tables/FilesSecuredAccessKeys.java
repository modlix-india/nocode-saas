...
public class FilesSecuredAccessKeys extends TableImpl<FilesSecuredAccessKeysRecord> {
     ...
     */
    public final TableField<FilesSecuredAccessKeysRecord, LocalDateTime> CREATED_AT = createField(DSL.name("CREATED_AT"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "Time when this row is created");

    private FilesSecuredAccessKeys(Name alias, Table<FilesSecuredAccessKeysRecord> aliased) {
        this(alias, aliased, null);
    }

    private FilesSecuredAccessKeys(Name alias, Table<FilesSecuredAccessKeysRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> FilesSecuredAccessKeys(Table<O> child, ForeignKey<O, FilesSecuredAccessKeysRecord> key) {
        super(child, key, FILES_SECURED_ACCESS_KEYS);
    }
