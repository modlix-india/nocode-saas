...
import com.modlix.saas.commons2.jooq.flow.schema.enums.IndexDirection;
import com.modlix.saas.commons2.jooq.flow.schema.enums.KeyType;
import com.modlix.saas.commons2.jooq.flow.schema.enums.ReferenceType;
import lombok.Data;
...
public class KeySchema extends Schema {
    ...
    public static KeySchema ofKey(String name, KeyType keyType, List<String> columns) {
        return (KeySchema) new KeySchema().setKeyType(keyType.name()).setColumns(columns).setName(name);
    }
