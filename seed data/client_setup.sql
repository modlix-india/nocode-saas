...
CREATE TABLE `security_app_reg_integration` (
    ...
    `INTG_ID` VARCHAR(1024) NOT NULL COMMENT 'Integration ID',
    `INTG_SECRET` VARCHAR(1024) NOT NULL COMMENT 'Integration Secret',
    `LOGIN_URI` VARCHAR(1024) NOT NULL COMMENT 'URI for login',
...
CREATE TABLE `security_app_reg_integration_tokens` (
    ...
    `STATE` VARCHAR(512) DEFAULT NULL COMMENT 'Session id for login',
