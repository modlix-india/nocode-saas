...
public class EntityCollectorLog extends TableImpl<EntityCollectorLogRecord> {
     ...
     */
    public final TableField<EntityCollectorLogRecord, EntityCollectorLogStatus> STATUS = createField(DSL.name("STATUS"), SQLDataType.VARCHAR(16).asEnumDataType(EntityCollectorLogStatus.class), this, "Status of the entity transfer");
