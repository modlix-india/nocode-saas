...
public class EntityIntegrations extends TableImpl<EntityIntegrationsRecord> {
     ...
     */
    public final TableField<EntityIntegrationsRecord, String> PRIMARY_TARGET = createField(DSL.name("PRIMARY_TARGET"), SQLDataType.VARCHAR(255).nullable(false), this, "Primary target to forwarded entity");
     ...
     */
    public final TableField<EntityIntegrationsRecord, String> SECONDARY_TARGET = createField(DSL.name("SECONDARY_TARGET"), SQLDataType.VARCHAR(255), this, "Secondary target to forwarded entity");

    /**
     * The column <code>entity_collector.entity_integrations.IN_SOURCE</code>.
     * Source
     */
    public final TableField<EntityIntegrationsRecord, String> IN_SOURCE = createField(DSL.name("IN_SOURCE"), SQLDataType.VARCHAR(255).nullable(false), this, "Source");
     ...
     */
    public final TableField<EntityIntegrationsRecord, String> PRIMARY_VERIFY_TOKEN = createField(DSL.name("PRIMARY_VERIFY_TOKEN"), SQLDataType.VARCHAR(255), this, "Primary verification token is verify the primary target");
