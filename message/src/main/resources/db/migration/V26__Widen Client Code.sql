...
ALTER TABLE `message`.`message_dispatch_outbox`
    MODIFY COLUMN `CLIENT_CODE` CHAR(12) NOT NULL COMMENT 'Client Code this handoff belongs to.';
ALTER TABLE `message`.`message_exotel_calls`
    MODIFY COLUMN `CLIENT_CODE` CHAR(12) NOT NULL COMMENT 'Client Code related to this Exotel Call.';
ALTER TABLE `message`.`message_message_webhooks`
    MODIFY COLUMN `CLIENT_CODE` CHAR(12) NOT NULL COMMENT 'Client Code related to this message.';
...
ALTER TABLE `message`.`message_whatsapp_phone_numbers`
    MODIFY COLUMN `CLIENT_CODE` CHAR(12) NOT NULL COMMENT 'Client Code related to this WhatsApp phone number.';
ALTER TABLE `message`.`message_whatsapp_templates`
    MODIFY COLUMN `CLIENT_CODE` CHAR(12) NOT NULL COMMENT 'Client Code related to this WhatsApp template.';
