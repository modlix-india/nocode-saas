package com.fincity.saas.message.dao.message.provider;
...
public abstract class AbstractMessageProviderDAO<R extends UpdatableRecord<R>, D extends BaseUpdatableDto<D>>
        extends BaseUpdatableDAO<R, D> {

    protected final Field<String> uniqueProviderField;

    protected AbstractMessageProviderDAO(
