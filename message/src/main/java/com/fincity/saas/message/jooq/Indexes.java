...
public class Indexes {
    ...
    public static final Index MESSAGE_PROVIDER_USER_ENDPOINTS_IDX1_PROVIDER_USER_ENDPOINTS_ROUTING = Internal.createIndex(DSL.name("IDX1_PROVIDER_USER_ENDPOINTS_ROUTING"), MessageProviderUserEndpoints.MESSAGE_PROVIDER_USER_ENDPOINTS, new OrderField[] { MessageProviderUserEndpoints.MESSAGE_PROVIDER_USER_ENDPOINTS.APP_CODE, MessageProviderUserEndpoints.MESSAGE_PROVIDER_USER_ENDPOINTS.USER_ID, MessageProviderUserEndpoints.MESSAGE_PROVIDER_USER_ENDPOINTS.IS_ACTIVE, MessageProviderUserEndpoints.MESSAGE_PROVIDER_USER_ENDPOINTS.PRIORITY }, false);
