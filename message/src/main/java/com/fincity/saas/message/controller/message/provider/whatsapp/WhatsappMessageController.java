...
public class WhatsappMessageController
    ...
    @GetMapping("/send/can-send")
    public Mono<ResponseEntity<Boolean>> canSendNonTemplateMessage(@RequestBody WhatsappMessageCswRequest request) {
        return this.service.canSendNonTemplateMessage(request).map(ResponseEntity::ok);
    }
