...
public class MessageWhatsappMessages extends TableImpl<MessageWhatsappMessagesRecord> {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.MESSAGE_WHATSAPP_MESSAGES_IDX_WHATSAPP_MESSAGES_FROM_PHONE, Indexes.MESSAGE_WHATSAPP_MESSAGES_IDX_WHATSAPP_MESSAGES_MESSAGE_ID, Indexes.MESSAGE_WHATSAPP_MESSAGES_IDX_WHATSAPP_MESSAGES_MESSAGE_STATUS, Indexes.MESSAGE_WHATSAPP_MESSAGES_IDX_WHATSAPP_MESSAGES_TO_PHONE);
    }
