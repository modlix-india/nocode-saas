...
public class Keys {
    ...
    public static final UniqueKey<MessageWhatsappBusinessAccountsRecord> KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS_PRIMARY = Internal.createUniqueKey(MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS, DSL.name("KEY_message_whatsapp_business_accounts_PRIMARY"), new TableField[] { MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS.ID }, true);
    public static final UniqueKey<MessageWhatsappBusinessAccountsRecord> KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS_UK1_MESSAGES_CODE = Internal.createUniqueKey(MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS, DSL.name("KEY_message_whatsapp_business_accounts_UK1_MESSAGES_CODE"), new TableField[] { MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS.CODE }, true);
    ...
    public static final ForeignKey<MessageWhatsappMessagesRecord, MessageWhatsappBusinessAccountsRecord> FK1_WHATSAPP_MESSAGES_WHATSAPP_BUSINESS_ACCOUNT_ID = Internal.createForeignKey(MessageWhatsappMessages.MESSAGE_WHATSAPP_MESSAGES, DSL.name("FK1_WHATSAPP_MESSAGES_WHATSAPP_BUSINESS_ACCOUNT_ID"), new TableField[] { MessageWhatsappMessages.MESSAGE_WHATSAPP_MESSAGES.WHATSAPP_BUSINESS_ACCOUNT_ID }, Keys.KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS_PRIMARY, new TableField[] { MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS.ID }, true);
    public static final ForeignKey<MessageWhatsappPhoneNumbersRecord, MessageWhatsappBusinessAccountsRecord> FK1_WHATSAPP_PHONE_NUMBERS_WHATSAPP_BUSINESS_ACCOUNT_ID = Internal.createForeignKey(MessageWhatsappPhoneNumbers.MESSAGE_WHATSAPP_PHONE_NUMBERS, DSL.name("FK1_WHATSAPP_PHONE_NUMBERS_WHATSAPP_BUSINESS_ACCOUNT_ID"), new TableField[] { MessageWhatsappPhoneNumbers.MESSAGE_WHATSAPP_PHONE_NUMBERS.WHATSAPP_BUSINESS_ACCOUNT_ID }, Keys.KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS_PRIMARY, new TableField[] { MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS.ID }, true);
    public static final ForeignKey<MessageWhatsappTemplatesRecord, MessageWhatsappBusinessAccountsRecord> FK1_WHATSAPP_TEMPLATES_WHATSAPP_BUSINESS_ACCOUNT_ID = Internal.createForeignKey(MessageWhatsappTemplates.MESSAGE_WHATSAPP_TEMPLATES, DSL.name("FK1_WHATSAPP_TEMPLATES_WHATSAPP_BUSINESS_ACCOUNT_ID"), new TableField[] { MessageWhatsappTemplates.MESSAGE_WHATSAPP_TEMPLATES.WHATSAPP_BUSINESS_ACCOUNT_ID }, Keys.KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS_PRIMARY, new TableField[] { MessageWhatsappBusinessAccounts.MESSAGE_WHATSAPP_BUSINESS_ACCOUNTS.ID }, true);
}
