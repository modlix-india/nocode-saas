...
public class Keys {
    ...
    public static final UniqueKey<MessageProviderIdentifiersRecord> KEY_MESSAGE_PROVIDER_IDENTIFIERS_PRIMARY = Internal.createUniqueKey(MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS, DSL.name("KEY_message_provider_identifiers_PRIMARY"), new TableField[] { MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.ID }, true);
    public static final UniqueKey<MessageProviderIdentifiersRecord> KEY_MESSAGE_PROVIDER_IDENTIFIERS_UK1_PROVIDER_IDENTIFIER_CODE = Internal.createUniqueKey(MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS, DSL.name("KEY_message_provider_identifiers_UK1_PROVIDER_IDENTIFIER_CODE"), new TableField[] { MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.CODE }, true);
    public static final UniqueKey<MessageProviderIdentifiersRecord> KEY_MESSAGE_PROVIDER_IDENTIFIERS_UK2_PROVIDER_IDENTIFIER_APP_CODE_CLIENT_CODE_IDENTIFIER = Internal.createUniqueKey(MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS, DSL.name("KEY_message_provider_identifiers_UK2_PROVIDER_IDENTIFIER_APP_CODE_CLIENT_CODE_IDENTIFIER"), new TableField[] { MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.APP_CODE, MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.CLIENT_CODE, MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.CONNECTION_TYPE, MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.CONNECTION_SUB_TYPE, MessageProviderIdentifiers.MESSAGE_PROVIDER_IDENTIFIERS.IDENTIFIER }, true);
    ...
    public static final ForeignKey<MessageMessagesRecord, MessageWhatsappTemplatesRecord> FK2_MESSAGES_WHATSAPP_TEMPLATES_ID = Internal.createForeignKey(MessageMessages.MESSAGE_MESSAGES, DSL.name("FK2_MESSAGES_WHATSAPP_TEMPLATES_ID"), new TableField[] { MessageMessages.MESSAGE_MESSAGES.WHATSAPP_TEMPLATE_ID }, Keys.KEY_MESSAGE_WHATSAPP_TEMPLATES_PRIMARY, new TableField[] { MessageWhatsappTemplates.MESSAGE_WHATSAPP_TEMPLATES.ID }, true);
}
