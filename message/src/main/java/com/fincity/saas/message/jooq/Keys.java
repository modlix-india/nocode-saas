...
public class Keys {
    ...
    public static final ForeignKey<MessageWhatsappMessagesRecord, MessageWhatsappBusinessAccountRecord> FK1_WHATSAPP_MESSAGES_WHATSAPP_BUSINESS_ACCOUNT_ID = Internal.createForeignKey(MessageWhatsappMessages.MESSAGE_WHATSAPP_MESSAGES, DSL.name("FK1_WHATSAPP_MESSAGES_WHATSAPP_BUSINESS_ACCOUNT_ID"), new TableField[] { MessageWhatsappMessages.MESSAGE_WHATSAPP_MESSAGES.WHATSAPP_BUSINESS_ACCOUNT_ID }, Keys.KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNT_PRIMARY, new TableField[] { MessageWhatsappBusinessAccount.MESSAGE_WHATSAPP_BUSINESS_ACCOUNT.ID }, true);
    public static final ForeignKey<MessageWhatsappPhoneNumberRecord, MessageWhatsappBusinessAccountRecord> FK1_WHATSAPP_PHONE_NUMBERS_WHATSAPP_BUSINESS_ACCOUNT_ID = Internal.createForeignKey(MessageWhatsappPhoneNumber.MESSAGE_WHATSAPP_PHONE_NUMBER, DSL.name("FK1_WHATSAPP_PHONE_NUMBERS_WHATSAPP_BUSINESS_ACCOUNT_ID"), new TableField[] { MessageWhatsappPhoneNumber.MESSAGE_WHATSAPP_PHONE_NUMBER.WHATSAPP_BUSINESS_ACCOUNT_ID }, Keys.KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNT_PRIMARY, new TableField[] { MessageWhatsappBusinessAccount.MESSAGE_WHATSAPP_BUSINESS_ACCOUNT.ID }, true);
    public static final ForeignKey<MessageWhatsappTemplatesRecord, MessageWhatsappBusinessAccountRecord> FK1_WHATSAPP_TEMPLATES_WHATSAPP_BUSINESS_ACCOUNT_ID = Internal.createForeignKey(MessageWhatsappTemplates.MESSAGE_WHATSAPP_TEMPLATES, DSL.name("FK1_WHATSAPP_TEMPLATES_WHATSAPP_BUSINESS_ACCOUNT_ID"), new TableField[] { MessageWhatsappTemplates.MESSAGE_WHATSAPP_TEMPLATES.WHATSAPP_BUSINESS_ACCOUNT_ID }, Keys.KEY_MESSAGE_WHATSAPP_BUSINESS_ACCOUNT_PRIMARY, new TableField[] { MessageWhatsappBusinessAccount.MESSAGE_WHATSAPP_BUSINESS_ACCOUNT.ID }, true);
}
