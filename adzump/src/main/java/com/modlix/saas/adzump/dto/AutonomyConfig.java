...
public class AutonomyConfig extends AbstractUpdatableDTO<ULong, ULong> {

    @Serial
    private static final long serialVersionUID = 6029384756102938476L;

    private String clientCode;
    private AdzumpAutonomyConfigScope scope;
