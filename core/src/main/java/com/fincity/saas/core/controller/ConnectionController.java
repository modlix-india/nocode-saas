...
public class ConnectionController
    ...
    public Mono<ResponseEntity<String>> postMethodName(@RequestParam(required = true) String connectionName,
    ...
    public Mono<ResponseEntity<Void>> postMethodName1(ServerHttpRequest request, ServerHttpResponse response) {
