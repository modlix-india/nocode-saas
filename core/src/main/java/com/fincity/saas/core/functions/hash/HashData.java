package com.fincity.saas.core.functions.hash;
...
public class HashData extends AbstractReactiveFunction {
    ...
    public FunctionSignature getSignature() {
        ...
        Map<String, Parameter> parameters = Map.ofEntries(
                ...
                Parameter.ofEntry(PARAMETER_ALGORITHM, Schema.ofString(PARAMETER_ALGORITHM).setEnums(List.of(
                ...
                Parameter.ofEntry(PARAMETER_PRIMITIVE_LEVEL, Schema.ofBoolean(PARAMETER_PRIMITIVE_LEVEL)
