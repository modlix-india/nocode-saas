...
public class PatchRequest extends AbstractReactiveFunction  {
	private static final String URL = "url";

	private static final String FUNCTION_NAME = "PatchRequest";
	...
	public PatchRequest(RestService restService) {
