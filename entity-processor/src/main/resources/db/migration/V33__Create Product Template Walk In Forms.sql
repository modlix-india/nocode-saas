CREATE TABLE `entity_processor`.`entity_processor_product_templates_walk_in_forms` (
    ...
    `STAGE_ID`            BIGINT UNSIGNED               NULL COMMENT 'Status for this Product template walk in form.',
    ...
    UNIQUE KEY `UK2_PRODUCT_TEMPLATES_WALK_IN_FORMS_APP_CLIENT_PRODUCT_TEMPLATE`(`APP_CODE`,`CLIENT_CODE`,`PRODUCT_TEMPLATE_ID`),
