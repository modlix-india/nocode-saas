...
public class EntityProcessorSimpleRulesRecord extends UpdatableRecordImpl<EntityProcessorSimpleRulesRecord> {
    ...
    public ComparisonOperator getComparisonOperator() {
        return (ComparisonOperator) get(10);
    }
