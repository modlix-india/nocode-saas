...
public class EntityProcessorProducts extends TableImpl<EntityProcessorProductsRecord> {
     ...
     */
    public final TableField<EntityProcessorProductsRecord, String> CLIENT_CODE = createField(DSL.name("CLIENT_CODE"), SQLDataType.CHAR(12).nullable(false), this, "Client Code to whom this notification we sent.");
    ...
    public EntityProcessorProductTicketExRulesPath entityProcessorProductTicketExRules() {
        if (_entityProcessorProductTicketExRules == null)
            _entityProcessorProductTicketExRules = new EntityProcessorProductTicketExRulesPath(this, null, Keys.FK1_PTER_PID.getInverseKey());
