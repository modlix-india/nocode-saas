...
public class EntityProcessorPartners extends TableImpl<EntityProcessorPartnersRecord> {
     ...
     */
    public final TableField<EntityProcessorPartnersRecord, EntityProcessorPartnersPartnerVerificationStatus> PARTNER_VERIFICATION_STATUS = createField(DSL.name("PARTNER_VERIFICATION_STATUS"), SQLDataType.VARCHAR(18).nullable(false).asEnumDataType(EntityProcessorPartnersPartnerVerificationStatus.class), this, "Partner verification status.");
