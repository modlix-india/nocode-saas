...
public class Keys {
    ...
    public static final UniqueKey<EntityProcessorProductRulesRecord> KEY_ENTITY_PROCESSOR_PRODUCT_RULES_UK2_PRODUCT_RULES_VALUE_TEMPLATE_ID_PLATFORM = Internal.createUniqueKey(EntityProcessorProductRules.ENTITY_PROCESSOR_PRODUCT_RULES, DSL.name("KEY_entity_processor_product_rules_UK2_PRODUCT_RULES_VALUE_TEMPLATE_ID_PLATFORM"), new TableField[] { EntityProcessorProductRules.ENTITY_PROCESSOR_PRODUCT_RULES.APP_CODE, EntityProcessorProductRules.ENTITY_PROCESSOR_PRODUCT_RULES.CLIENT_CODE, EntityProcessorProductRules.ENTITY_PROCESSOR_PRODUCT_RULES.PRODUCT_ID, EntityProcessorProductRules.ENTITY_PROCESSOR_PRODUCT_RULES.PLATFORM }, true);
    ...
    public static final UniqueKey<EntityProcessorValueTemplateRulesRecord> KEY_ENTITY_PROCESSOR_VALUE_TEMPLATE_RULES_UK2_VALUE_TEMPLATE_RULES_VALUE_TEMPLATE_ID_PLATFORM = Internal.createUniqueKey(EntityProcessorValueTemplateRules.ENTITY_PROCESSOR_VALUE_TEMPLATE_RULES, DSL.name("KEY_entity_processor_value_template_rules_UK2_VALUE_TEMPLATE_RULES_VALUE_TEMPLATE_ID_PLATFORM"), new TableField[] { EntityProcessorValueTemplateRules.ENTITY_PROCESSOR_VALUE_TEMPLATE_RULES.APP_CODE, EntityProcessorValueTemplateRules.ENTITY_PROCESSOR_VALUE_TEMPLATE_RULES.CLIENT_CODE, EntityProcessorValueTemplateRules.ENTITY_PROCESSOR_VALUE_TEMPLATE_RULES.VALUE_TEMPLATE_ID, EntityProcessorValueTemplateRules.ENTITY_PROCESSOR_VALUE_TEMPLATE_RULES.PLATFORM }, true);
