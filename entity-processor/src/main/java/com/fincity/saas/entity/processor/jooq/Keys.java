...
public class Keys {
    ...
    public static final UniqueKey<EntityProcessorSourcesRecord> KEY_ENTITY_PROCESSOR_SOURCES_UK2_SOURCES_NAME = Internal.createUniqueKey(EntityProcessorSources.ENTITY_PROCESSOR_SOURCES, DSL.name("KEY_entity_processor_sources_UK2_SOURCES_NAME"), new TableField[] { EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.APP_CODE, EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.CLIENT_CODE, EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.VALUE_TEMPLATE_ID, EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.NAME, EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.PLATFORM }, true);
    ...
    public static final ForeignKey<EntityProcessorProductsRecord, EntityProcessorValueTemplatesRecord> FK1_PRODUCTS_VALUE_TEMPLATE_ID = Internal.createForeignKey(EntityProcessorProducts.ENTITY_PROCESSOR_PRODUCTS, DSL.name("FK1_PRODUCTS_VALUE_TEMPLATE_ID"), new TableField[] { EntityProcessorProducts.ENTITY_PROCESSOR_PRODUCTS.VALUE_TEMPLATE_ID }, Keys.KEY_ENTITY_PROCESSOR_VALUE_TEMPLATES_PRIMARY, new TableField[] { EntityProcessorValueTemplates.ENTITY_PROCESSOR_VALUE_TEMPLATES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
    public static final ForeignKey<EntityProcessorSourcesRecord, EntityProcessorValueTemplatesRecord> FK1_SOURCES_VALUE_TEMPLATE_ID = Internal.createForeignKey(EntityProcessorSources.ENTITY_PROCESSOR_SOURCES, DSL.name("FK1_SOURCES_VALUE_TEMPLATE_ID"), new TableField[] { EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.VALUE_TEMPLATE_ID }, Keys.KEY_ENTITY_PROCESSOR_VALUE_TEMPLATES_PRIMARY, new TableField[] { EntityProcessorValueTemplates.ENTITY_PROCESSOR_VALUE_TEMPLATES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
    public static final ForeignKey<EntityProcessorSourcesRecord, EntityProcessorSourcesRecord> FK2_SOURCES_PARENT_LEVEL_0 = Internal.createForeignKey(EntityProcessorSources.ENTITY_PROCESSOR_SOURCES, DSL.name("FK2_SOURCES_PARENT_LEVEL_0"), new TableField[] { EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.PARENT_LEVEL_0 }, Keys.KEY_ENTITY_PROCESSOR_SOURCES_PRIMARY, new TableField[] { EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
    public static final ForeignKey<EntityProcessorSourcesRecord, EntityProcessorSourcesRecord> FK3_SOURCES_PARENT_LEVEL_1 = Internal.createForeignKey(EntityProcessorSources.ENTITY_PROCESSOR_SOURCES, DSL.name("FK3_SOURCES_PARENT_LEVEL_1"), new TableField[] { EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.PARENT_LEVEL_1 }, Keys.KEY_ENTITY_PROCESSOR_SOURCES_PRIMARY, new TableField[] { EntityProcessorSources.ENTITY_PROCESSOR_SOURCES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
    public static final ForeignKey<EntityProcessorStagesRecord, EntityProcessorValueTemplatesRecord> FK1_STAGES_VALUE_TEMPLATE_ID = Internal.createForeignKey(EntityProcessorStages.ENTITY_PROCESSOR_STAGES, DSL.name("FK1_STAGES_VALUE_TEMPLATE_ID"), new TableField[] { EntityProcessorStages.ENTITY_PROCESSOR_STAGES.VALUE_TEMPLATE_ID }, Keys.KEY_ENTITY_PROCESSOR_VALUE_TEMPLATES_PRIMARY, new TableField[] { EntityProcessorValueTemplates.ENTITY_PROCESSOR_VALUE_TEMPLATES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
    public static final ForeignKey<EntityProcessorStagesRecord, EntityProcessorStagesRecord> FK2_STAGES_PARENT_LEVEL_0 = Internal.createForeignKey(EntityProcessorStages.ENTITY_PROCESSOR_STAGES, DSL.name("FK2_STAGES_PARENT_LEVEL_0"), new TableField[] { EntityProcessorStages.ENTITY_PROCESSOR_STAGES.PARENT_LEVEL_0 }, Keys.KEY_ENTITY_PROCESSOR_STAGES_PRIMARY, new TableField[] { EntityProcessorStages.ENTITY_PROCESSOR_STAGES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
    public static final ForeignKey<EntityProcessorStagesRecord, EntityProcessorStagesRecord> FK3_STAGES_PARENT_LEVEL_1 = Internal.createForeignKey(EntityProcessorStages.ENTITY_PROCESSOR_STAGES, DSL.name("FK3_STAGES_PARENT_LEVEL_1"), new TableField[] { EntityProcessorStages.ENTITY_PROCESSOR_STAGES.PARENT_LEVEL_1 }, Keys.KEY_ENTITY_PROCESSOR_STAGES_PRIMARY, new TableField[] { EntityProcessorStages.ENTITY_PROCESSOR_STAGES.ID }, true, ForeignKeyRule.RESTRICT, ForeignKeyRule.CASCADE);
}
