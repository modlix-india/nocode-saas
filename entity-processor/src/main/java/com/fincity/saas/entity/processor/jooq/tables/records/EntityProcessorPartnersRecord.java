...
import com.fincity.saas.entity.processor.jooq.enums.EntityProcessorPartnersPartnerVerificationStatus;
...
public class EntityProcessorPartnersRecord extends UpdatableRecordImpl<EntityProcessorPartnersRecord> {
     ...
     */
    public EntityProcessorPartnersRecord setPartnerVerificationStatus(EntityProcessorPartnersPartnerVerificationStatus value) {
        set(8, value);
        return this;
    }
     ...
     * Partner verification status.
     */
    public EntityProcessorPartnersPartnerVerificationStatus getPartnerVerificationStatus() {
        return (EntityProcessorPartnersPartnerVerificationStatus) get(8);
    }
     ...
     */
    public EntityProcessorPartnersRecord(ULong id, String appCode, String clientCode, String code, String name, String description, ULong clientId, ULong managerId, EntityProcessorPartnersPartnerVerificationStatus partnerVerificationStatus, Byte tempActive, Byte isActive, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(EntityProcessorPartners.ENTITY_PROCESSOR_PARTNERS);
