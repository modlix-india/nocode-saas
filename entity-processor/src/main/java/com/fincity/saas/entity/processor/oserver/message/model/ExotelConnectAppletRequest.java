...
import com.fincity.saas.entity.processor.util.SetterUtil;
...
public class ExotelConnectAppletRequest implements Serializable {
    ...
    public static ExotelConnectAppletRequest of(MultiValueMap<String, String> map) {
        ...
        req.setDialCallDuration(SetterUtil.parseLong(map.get("DialCallDuration")));
