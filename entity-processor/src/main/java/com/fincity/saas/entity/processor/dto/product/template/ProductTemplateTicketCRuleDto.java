...
@FieldNameConstants
public class ProductTemplateTicketCRuleDto extends BaseRuleDto<ProductTemplateTicketCRuleDto> {
    ...
    public ProductTemplateTicketCRuleDto() {
        super();
        this.relationsMap.put(Fields.productTemplateId, EntitySeries.PRODUCT_TEMPLATE.getTable());
    }

    public ProductTemplateTicketCRuleDto(ProductTemplateTicketCRuleDto productTemplateTicketCRule) {
        super(productTemplateTicketCRule);
        this.productTemplateId = productTemplateTicketCRule.productTemplateId;
    }
    ...
    @Override
    public ProductTemplateTicketCRuleDto setEntityId(ULong entityId) {
