...
public class ClientPasswordPolicyDAO
	...
	public Flux<PastPassword> getPastPasswordsBasedOnPolicy(ClientPasswordPolicy clientPasswordPolicy,
			ULong userId) {

		return Flux.from(this.dslContext.selectFrom(SECURITY_PAST_PASSWORDS)
