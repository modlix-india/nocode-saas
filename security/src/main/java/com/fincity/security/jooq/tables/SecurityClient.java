...
import com.fincity.security.jooq.tables.SecurityCreditPricing.SecurityCreditPricingPath;
...
public class SecurityClient extends TableImpl<SecurityClientRecord> {
    ...
    private transient SecurityClientManagerPath _securityClientManager;

    /**
     * Get the implicit to-many join path to the
     * <code>security.security_client_manager</code> table
     */
    public SecurityClientManagerPath securityClientManager() {
        if (_securityClientManager == null)
            _securityClientManager = new SecurityClientManagerPath(this, null, Keys.FK1_CLIENT_MANAGER_CLIENT_ID.getInverseKey());
    ...
    private transient SecurityCreditPricingPath _securityCreditPricing;

    /**
     * Get the implicit to-many join path to the
     * <code>security.security_credit_pricing</code> table
     */
    public SecurityCreditPricingPath securityCreditPricing() {
        if (_securityCreditPricing == null)
            _securityCreditPricing = new SecurityCreditPricingPath(this, null, Keys.FK1_CREDIT_PRICING_CLIENT_ID.getInverseKey());

        return _securityCreditPricing;
    }
    ...
    private transient SecurityClientActivityPath _securityClientActivity;

    /**
     * Get the implicit to-many join path to the
     * <code>security.security_client_activity</code> table
     */
    public SecurityClientActivityPath securityClientActivity() {
        if (_securityClientActivity == null)
            _securityClientActivity = new SecurityClientActivityPath(this, null, Keys.FK_CLIENT_ACTIVITY_CLIENT.getInverseKey());

        return _securityClientActivity;
    }
