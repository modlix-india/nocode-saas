...
public class SecurityUserRecord extends UpdatableRecordImpl<SecurityUserRecord> implements Record20<ULong, ULong, String, String, String, String, String, String, String, String, Byte, Byte, Byte, Byte, Short, SecurityUserStatusCode, ULong, LocalDateTime, ULong, LocalDateTime> {
    ...
    public SecurityUserStatusCode getStatusCode() {
        return (SecurityUserStatusCode) get(15);
    }
    ...
    @Override
    public Row20<ULong, ULong, String, String, String, String, String, String, String, String, Byte, Byte, Byte, Byte, Short, SecurityUserStatusCode, ULong, LocalDateTime, ULong, LocalDateTime> valuesRow() {
    ...
    @Override
    public Field<SecurityUserStatusCode> field16() {
    ...
    @Override
    public SecurityUserStatusCode component16() {
    ...
    @Override
    public SecurityUserStatusCode value16() {
        return getStatusCode();
    }
    ...
    @Override
    public SecurityUserRecord value11(Byte value) {
    ...
    @Override
    public SecurityUserRecord value15(Short value) {
        setNoFailedAttempt(value);
        return this;
    }

    @Override
    public SecurityUserRecord value16(SecurityUserStatusCode value) {
        setStatusCode(value);
        return this;
    }

    @Override
    public SecurityUserRecord value17(ULong value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public SecurityUserRecord value18(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public SecurityUserRecord value19(ULong value) {
        setUpdatedBy(value);
        return this;
    }

    @Override
    public SecurityUserRecord value20(LocalDateTime value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public SecurityUserRecord values(ULong value1, ULong value2, String value3, String value4, String value5, String value6, String value7, String value8, String value9, String value10, Byte value11, Byte value12, Byte value13, Byte value14, Short value15, SecurityUserStatusCode value16, ULong value17, LocalDateTime value18, ULong value19, LocalDateTime value20) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SecurityUserRecord(ULong id, ULong clientId, String userName, String emailId, String phoneNumber, String firstName, String lastName, String middleName, String localeCode, String password, Byte passwordHashed, Byte accountNonExpired, Byte accountNonLocked, Byte credentialsNonExpired, Short noFailedAttempt, SecurityUserStatusCode statusCode, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(SecurityUser.SECURITY_USER);
