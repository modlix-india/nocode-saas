...
public class SecurityClientPasswordPolicyRecord extends UpdatableRecordImpl<SecurityClientPasswordPolicyRecord> implements Record19<ULong, ULong, Byte, Byte, Byte, Byte, Byte, String, UShort, UShort, UShort, UShort, UShort, UShort, UShort, ULong, LocalDateTime, ULong, LocalDateTime> {
    ...
    @Override
    public Row19<ULong, ULong, Byte, Byte, Byte, Byte, Byte, String, UShort, UShort, UShort, UShort, UShort, UShort, UShort, ULong, LocalDateTime, ULong, LocalDateTime> valuesRow() {
