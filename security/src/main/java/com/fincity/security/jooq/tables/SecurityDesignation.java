...
public class SecurityDesignation extends TableImpl<SecurityDesignationRecord> {
     ...
     */
    public final TableField<SecurityDesignationRecord, ULong> DEPARTMENT_ID = createField(DSL.name("DEPARTMENT_ID"), SQLDataType.BIGINTUNSIGNED, this, "Department ID for which this designation belongs to");
    ...
    /**
     * The column <code>security.security_designation.PROFILE_ID</code>. Profile
     * ID for which this designation belongs to
     */
    public final TableField<SecurityDesignationRecord, ULong> PROFILE_ID = createField(DSL.name("PROFILE_ID"), SQLDataType.BIGINTUNSIGNED, this, "Profile ID for which this designation belongs to");
    ...
    public SecurityProfilePath securityProfile() {
        if (_securityProfile == null)
            _securityProfile = new SecurityProfilePath(this, Keys.FK5_DESIGNATION_PROFILE_ID, null);
    ...
    public SecurityUserInvitePath securityUserInvite() {
        if (_securityUserInvite == null)
            _securityUserInvite = new SecurityUserInvitePath(this, null, Keys.FK_SECURITY_USER_INVITE_DESIGNATION.getInverseKey());
