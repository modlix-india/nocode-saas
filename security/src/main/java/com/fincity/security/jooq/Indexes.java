...
public class Indexes {
    ...
    public static final Index SECURITY_USAGE_EVENT_IDX1_USAGE_EVENT_SCAN = Internal.createIndex(DSL.name("IDX1_USAGE_EVENT_SCAN"), SecurityUsageEvent.SECURITY_USAGE_EVENT, new OrderField[] { SecurityUsageEvent.SECURITY_USAGE_EVENT.CONSOLIDATED, SecurityUsageEvent.SECURITY_USAGE_EVENT.CREATED_AT }, false);
    ...
    public static final Index SECURITY_USAGE_EVENT_IDX2_USAGE_EVENT_GROUP = Internal.createIndex(DSL.name("IDX2_USAGE_EVENT_GROUP"), SecurityUsageEvent.SECURITY_USAGE_EVENT, new OrderField[] { SecurityUsageEvent.SECURITY_USAGE_EVENT.CLIENT_ID, SecurityUsageEvent.SECURITY_USAGE_EVENT.APP_ID, SecurityUsageEvent.SECURITY_USAGE_EVENT.ACTION_KEY }, false);
