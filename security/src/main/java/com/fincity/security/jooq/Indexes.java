...
public class Indexes {
    ...
    public static final Index SECURITY_DRAFT_TOKEN_IDX1_DRAFT_TOKEN_EXPIRES_AT = Internal.createIndex(DSL.name("IDX1_DRAFT_TOKEN_EXPIRES_AT"), SecurityDraftToken.SECURITY_DRAFT_TOKEN, new OrderField[] { SecurityDraftToken.SECURITY_DRAFT_TOKEN.EXPIRES_AT }, false);
