...
public class Indexes {
    ...
    public static final Index SECURITY_APP_SSO_FK1_APP_SSO_ACCESS_APP_ID = Internal.createIndex(DSL.name("FK1_APP_SSO_ACCESS_APP_ID"), SecurityAppSso.SECURITY_APP_SSO, new OrderField[] { SecurityAppSso.SECURITY_APP_SSO.APP_ID }, false);
