...
public class SecurityPackageRecord extends UpdatableRecordImpl<SecurityPackageRecord> implements Record9<ULong, String, String, String, Byte, ULong, LocalDateTime, ULong, LocalDateTime> {
    ...
    @Override
    public Row9<ULong, String, String, String, Byte, ULong, LocalDateTime, ULong, LocalDateTime> valuesRow() {
    ...
    @Override
    public SecurityPackageRecord value2(String value) {
        setCode(value);
        return this;
    }
    ...
    @Override
    public SecurityPackageRecord value5(Byte value) {
        setBase(value);
        return this;
    }

    @Override
    public SecurityPackageRecord value6(ULong value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public SecurityPackageRecord value7(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }
    ...
    @Override
    public SecurityPackageRecord values(ULong value1, String value2, String value3, String value4, Byte value5, ULong value6, LocalDateTime value7, ULong value8, LocalDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SecurityPackageRecord(ULong id, String code, String name, String description, Byte base, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(SecurityPackage.SECURITY_PACKAGE);
