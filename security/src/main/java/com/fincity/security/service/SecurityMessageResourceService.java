...
public class SecurityMessageResourceService extends AbstractMessageService {
    ...
    public static final String REMOVE_PROFILE_ERR0R = "remove_profile_error";
    public static final String ROLE_REMOVE_FROM_PROFILE_ERROR = "role_remove_from_profile_error";
    ...
    public static final String ASSIGN_PROFILE_TO_CLIENT_AND_APP = "assign_profile_to_client_and_app";
    public static final String APPLICATION_ACCESS_ERROR = "application_access_error";
    public static final String NO_PROFILE_ASSIGNED_TO_APP = "no_profile_assigned_to_app";
    public static final String REMOVE_PROFILE_FROM_APP_ERROR = "remove_profile_from_app_error";
