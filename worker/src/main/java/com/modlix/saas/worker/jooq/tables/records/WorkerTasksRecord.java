...
import com.modlix.saas.worker.jooq.tables.WorkerTasks;
...
public class WorkerTasksRecord extends UpdatableRecordImpl<WorkerTasksRecord> {
    ...
    /**
     * Setter for <code>worker.worker_tasks.TASK_JOB_TYPE</code>.
     */
    ...
    /**
     * Getter for <code>worker.worker_tasks.TASK_JOB_TYPE</code>.
     */
    ...
    public TaskLastFireStatus getTaskLastFireStatus() {
        return (TaskLastFireStatus) get(16);
    }
     ...
     */
    public WorkerTasksRecord(ULong id, String appCode, String clientCode, String name, ULong clientScheduleControlId, String description, TaskState taskState, TaskJobType taskJobType, Map jobData, Byte durable, LocalDateTime startTime, LocalDateTime endTime, String schedule, Byte recoverable, LocalDateTime nextFireTime, LocalDateTime lastFireTime, TaskLastFireStatus taskLastFireStatus, String lastFireResult, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(WorkerTasks.WORKER_TASKS);
