...
import com.modlix.saas.worker.jooq.Indexes;
import com.modlix.saas.worker.jooq.Keys;
import com.modlix.saas.worker.jooq.Worker;
import com.modlix.saas.worker.jooq.tables.WorkerClientScheduleControls.WorkerClientScheduleControlsPath;
...
public class WorkerTasks extends TableImpl<WorkerTasksRecord> {
     ...
     */
    public final TableField<WorkerTasksRecord, String> APP_CODE = createField(DSL.name("APP_CODE"), SQLDataType.CHAR(64), this, "App code on which this task was created.");
     ...
     */
    public final TableField<WorkerTasksRecord, TaskJobType> TASK_JOB_TYPE = createField(DSL.name("TASK_JOB_TYPE"), SQLDataType.VARCHAR(24).nullable(false).defaultValue(DSL.inline("SSL_RENEWAL", SQLDataType.VARCHAR)), this, "", new EnumConverter<String, TaskJobType>(String.class, TaskJobType.class));
