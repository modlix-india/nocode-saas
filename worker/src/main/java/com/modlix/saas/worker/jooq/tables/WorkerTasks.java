...
public class WorkerTasks extends TableImpl<WorkerTasksRecord> {
     ...
     */
    public final TableField<WorkerTasksRecord, TaskJobType> TASK_JOB_TYPE = createField(DSL.name("TASK_JOB_TYPE"), SQLDataType.VARCHAR(25).nullable(false).defaultValue(DSL.inline("SSL_RENEWAL", SQLDataType.VARCHAR)), this, "", new EnumConverter<String, TaskJobType>(String.class, TaskJobType.class));
