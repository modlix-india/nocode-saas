...
public class CloneUtil {
    ...
    public static <T> T cloneObject(T obj) {
        ...
        if (obj == null || obj instanceof Constable || obj instanceof Number) return obj;

        if (obj instanceof Map map) return (T) cloneMapObject(map);

        if (obj instanceof List lst) return (T) cloneMapList(lst);
