...
public class JsonFlattener {
    ...
    public static Map<String, String> convertToFlat(JsonElement job, String prefix,
    ...
    private static Map<String, String> flatten(JsonElement job, String prefix, Map<String, String> finalMap,
            Map<String, Set<SchemaType>> flattenedSchemaType) throws GenericException {
    ...
    private static void processAsJsonObject(JsonElement j1, String prefix, Map<String, String> finalMap,
            Map<String, Set<SchemaType>> schemaTypes) {
    ...
    private static void processAsJsonArray(JsonElement j2, String prefix, Map<String, String> finalMap,
            Map<String, Set<SchemaType>> schemaTypes) {
    ...
    private static String verifySchemaType(Set<SchemaType> schemaTypes, JsonElement value) {
        ...
        try {
            ...
            if (schemaTypes.contains(obtainedSchema.getT1()))
