...
public class Keys {
    ...
    public static final UniqueKey<DataStorageRecord> KEY_DATA_STORAGE_UK1_DATA_STRG = Internal.createUniqueKey(DataStorage.DATA_STORAGE, DSL.name("KEY_data_storage_UK1_DATA_STRG"), new TableField[] { DataStorage.DATA_STORAGE.APP_CODE, DataStorage.DATA_STORAGE.NAMESPACE, DataStorage.DATA_STORAGE.NAME }, true);
