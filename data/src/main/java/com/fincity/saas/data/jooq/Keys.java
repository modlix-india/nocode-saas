...
public class Keys {
    ...
    public static final UniqueKey<DataStorageRecord> KEY_DATA_STORAGE_UK1_DATA_STRG = Internal.createUniqueKey(DataStorage.DATA_STORAGE, DSL.name("KEY_data_storage_UK1_DATA_STRG"), new TableField[] { DataStorage.DATA_STORAGE.CLIENT_CODE, DataStorage.DATA_STORAGE.APP_CODE, DataStorage.DATA_STORAGE.NAMESPACE, DataStorage.DATA_STORAGE.NAME }, true);
    ...
    public static final UniqueKey<DataStorageRefFieldRecord> KEY_DATA_STORAGE_REF_FIELD_PRIMARY = Internal.createUniqueKey(DataStorageRefField.DATA_STORAGE_REF_FIELD, DSL.name("KEY_data_storage_ref_field_PRIMARY"), new TableField[] { DataStorageRefField.DATA_STORAGE_REF_FIELD.ID }, true);
    public static final UniqueKey<DataStorageRefFieldRecord> KEY_DATA_STORAGE_REF_FIELD_UK1_DATA_STRG_REF_FLD = Internal.createUniqueKey(DataStorageRefField.DATA_STORAGE_REF_FIELD, DSL.name("KEY_data_storage_ref_field_UK1_DATA_STRG_REF_FLD"), new TableField[] { DataStorageRefField.DATA_STORAGE_REF_FIELD.STORAGE_FIELD_ID }, true);
    ...
    public static final ForeignKey<DataStorageRefFieldRecord, DataStorageFieldRecord> FK1_STRG_REF_FLD_STRG_FLD_ID = Internal.createForeignKey(DataStorageRefField.DATA_STORAGE_REF_FIELD, DSL.name("FK1_STRG_REF_FLD_STRG_FLD_ID"), new TableField[] { DataStorageRefField.DATA_STORAGE_REF_FIELD.STORAGE_FIELD_ID }, Keys.KEY_DATA_STORAGE_FIELD_PRIMARY, new TableField[] { DataStorageField.DATA_STORAGE_FIELD.ID }, true);
    public static final ForeignKey<DataStorageRefFieldRecord, DataStorageRecord> FK1_STRG_REF_FLD_STRG_ID = Internal.createForeignKey(DataStorageRefField.DATA_STORAGE_REF_FIELD, DSL.name("FK1_STRG_REF_FLD_STRG_ID"), new TableField[] { DataStorageRefField.DATA_STORAGE_REF_FIELD.REF_STORAGE_ID }, Keys.KEY_DATA_STORAGE_PRIMARY, new TableField[] { DataStorage.DATA_STORAGE.ID }, true);
}
