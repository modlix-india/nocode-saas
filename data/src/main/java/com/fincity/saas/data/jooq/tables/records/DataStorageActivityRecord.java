...
public class DataStorageActivityRecord extends UpdatableRecordImpl<DataStorageActivityRecord> implements Record8<ULong, ULong, String, JSON, ULong, LocalDateTime, ULong, LocalDateTime> {
     ...
     * data
     */
    public DataStorageActivityRecord setOpData(JSON value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public Row8<ULong, ULong, String, JSON, ULong, LocalDateTime, ULong, LocalDateTime> valuesRow() {
    ...
    @Override
    public DataStorageActivityRecord value4(JSON value) {
        setOpData(value);
        return this;
    }
    ...
    @Override
    public DataStorageActivityRecord values(ULong value1, ULong value2, String value3, JSON value4, ULong value5, LocalDateTime value6, ULong value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DataStorageActivityRecord(ULong id, ULong storageId, String operation, JSON opData, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(DataStorageActivity.DATA_STORAGE_ACTIVITY);
