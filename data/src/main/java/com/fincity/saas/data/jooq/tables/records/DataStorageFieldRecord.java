...
public class DataStorageFieldRecord extends UpdatableRecordImpl<DataStorageFieldRecord> implements Record12<ULong, String, DataStorageFieldType, UShort, ULong, String, ULong, String, ULong, LocalDateTime, ULong, LocalDateTime> {
    ...
    /**
     * Setter for <code>data.data_storage_field.INTERNAL_NAME</code>. Name with
     * the storage field created.
     */
    public DataStorageFieldRecord setInternalName(String value) {
        set(7, value);
        return this;
    }

    /**
     * Getter for <code>data.data_storage_field.INTERNAL_NAME</code>. Name with
     * the storage field created.
     */
    ...
    @Override
    public Row12<ULong, String, DataStorageFieldType, UShort, ULong, String, ULong, String, ULong, LocalDateTime, ULong, LocalDateTime> valuesRow() {
    ...
    public Field<String> field8() {
        return DataStorageField.DATA_STORAGE_FIELD.INTERNAL_NAME;
    }
    ...
    @Override
    public DataStorageFieldRecord value8(String value) {
        setInternalName(value);
        return this;
    }

    @Override
    public DataStorageFieldRecord value9(ULong value) {
        setCreatedBy(value);
        return this;
    }

    @Override
    public DataStorageFieldRecord value10(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public DataStorageFieldRecord value11(ULong value) {
        setUpdatedBy(value);
        return this;
    }

    @Override
    public DataStorageFieldRecord value12(LocalDateTime value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public DataStorageFieldRecord values(ULong value1, String value2, DataStorageFieldType value3, UShort value4, ULong value5, String value6, ULong value7, String value8, ULong value9, LocalDateTime value10, ULong value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DataStorageFieldRecord(ULong id, String name, DataStorageFieldType type, UShort size, ULong storageId, String defaultValue, ULong refStorageFieldId, String internalName, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(DataStorageField.DATA_STORAGE_FIELD);
