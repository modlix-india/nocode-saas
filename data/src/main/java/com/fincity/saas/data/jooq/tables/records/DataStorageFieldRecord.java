...
public class DataStorageFieldRecord extends UpdatableRecordImpl<DataStorageFieldRecord> implements Record10<ULong, String, DataStorageFieldType, UShort, ULong, String, ULong, LocalDateTime, ULong, LocalDateTime> {
    ...
    @Override
    public Row10<ULong, String, DataStorageFieldType, UShort, ULong, String, ULong, LocalDateTime, ULong, LocalDateTime> valuesRow() {
    ...
    @Override
    public DataStorageFieldRecord value8(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }
    ...
    @Override
    public DataStorageFieldRecord values(ULong value1, String value2, DataStorageFieldType value3, UShort value4, ULong value5, String value6, ULong value7, LocalDateTime value8, ULong value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DataStorageFieldRecord(ULong id, String name, DataStorageFieldType type, UShort size, ULong storageId, String defaultValue, ULong createdBy, LocalDateTime createdAt, ULong updatedBy, LocalDateTime updatedAt) {
        super(DataStorageField.DATA_STORAGE_FIELD);
