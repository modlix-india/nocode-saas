...
@Transactional
public abstract class AbstractFlowUpdatableDAO<R extends UpdatableRecord<R>, I extends Serializable, D extends AbstractFlowUpdatableDTO<I, I>> extends AbstractUpdatableDAO<R, I, D> {
